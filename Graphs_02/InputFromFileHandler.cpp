...
void InputFromFileHandler::OpenFile()
{
	do 
	{
		GetFileNameFromUser();
...
void InputFromFileHandler::GetFileNameFromUser()
{
...
bool InputFromFileHandler::CheckIfFileExists()
{
...
SimpleGraph* InputFromFileHandler::GetInputFromFile()
{
	char fileType;
	...
	return new SimpleGraph(input, fileType);
